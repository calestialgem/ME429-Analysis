...
air = Air(5);
[v_top, Z_best] = SearchWheelDiameters(air, fan, Z_range, F_d, F_f);
vehicle = Vehicle(air, fan, Z_best, F_d, F_f);
...
SearchWindSpeeds(fan, 1:0.1:10, Z_best, Z_range, F_d, F_f);
